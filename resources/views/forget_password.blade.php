                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="{{ route('forgot_password') }}" method="POST" autocomplete="off">
                                @csrf
                                <h5 style="margin-bottom: 30px;color:#1f365c;">Forgot Password</h5>
                                <p style="margin-bottom: 15px;">We will send a link to reset your password</p>
                                <div class="form-group">
                                    <label>Email</label>
                                    <input class="au-input au-input--full" type="email" name="email" placeholder="Email">
                                </div>
                                
                                <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit">Forgot Password</button>
                            </form>
                        </div>
                    </div>
