<footer class="bg-gradient-aztec-green position-relative">
			...
			<div class="background-position-center-top h-8px w-100 position-absolute left-0px bottom-0" style="background-image: url('images/contact/border.jpg')"></div>
			<div class=
                <div class="">
    </div>
            </div>
            <div class="container footer-dark text-center text-sm-start position-relative"> 
                <div class="row mb-5 sm-mb-7 xs-mb-30px">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 ps-4 last-paragraph-no-margin md-mb-40px xs-mb-30px"> 
                        ...
                        <ul>
                            <li><a href="{{ route('list') }}">Victor Schwab</a></li>
                            <li><a href="{{ route('list') }}">John Caples</a></li>
                            <li><a href="{{ route('list') }}">Joe Cossman</a></li>
                            <li><a href="{{ route('list') }}">Dan Rosenthal</a></li>
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-6 text-md-center text-lg-start">
                        <span class="fs-18 fw-500 d-block mb-20px style2">Subscribe To Our Newsletter</span> 
                        <div class="d-inline-block w-100 newsletter-style-02 position-relative mb-15px">
                            <form action="email-templates/subscribe-newsletter.php" method="post" class="position-relative w-100">
                                ...
                                <button type="submit" aria-label="submit" class="btn pe-20px text-white fs-13 fw-500 lg-ps-15px lg-pe-15px submit">Submit</button>
                        ...
                        <div class="d-flex align-items-center justify-content-center justify-content-md-center justify-content-sm-start justify-content-lg-start fs-14">
                            <div class="d-inline-block style2">Your Privacy Is 100% Protected! Unsubscribe At Any Time.</div> 
                        </div>
                  </div>
                    <!-- end footer column -->
                </div> 
