<footer class="bg-gradient-aztec-green position-relative">
            <div class="position-absolute left-minus-100px top-25px">
                <img src="{{ asset('images/mentors/demo-elearning-bg-05555555.png') }}" alt="" class="w-80">
            </div>
            <div class="background-position-center-top h-100 w-100 position-absolute left-0px top-0" style="background-image: url('images/mentors/vertical-line-bg-small.svg')"></div>
            <div class="container overlap-section">
                <div class="row g-0 justify-content-center align-items-center text-center bg-base-color border-radius-6px ps-5 pe-5 pt-3 pb-3 mb-8 sm-p-25px background-position-left-bottom background-no-repeat contain-background position-relative" style="background-image: url('images/mentors/demo-elearning-bg-0666.png')">
                    <!-- start footer column -->
                    <div class="col-lg-auto lg-mb-20px">
                        <h6 class="alt-font fw-600 text-dark-gray m-0 ls-minus-1px d-inline-block me-30px lg-me-0">Start Learning From Your Favorite Mentors Today For Only $10!</h6>
                    </div>
                    <!-- end footer column -->
                    <!-- start footer column -->
                    <div class="col-auto">
                        <a href="{{ route('register') }}" class="btn btn-extra-large btn-dark-gray btn-rounded btn-box-shadow btn-switch-text d-inline-block me-20px align-middle xs-m-0">
                            <span>
                                <span class="btn-double-text" data-text="Get started now ->">Get started now -></span>
                                <span></span>
                            </span>
                        </a>
                        <span class="d-block d-sm-inline-block text-dark-gray fs-19 fw-600 left-icon d-inline-block align-middle xs-mt-10px ls-minus-05px"></span>
                    </div>
                    <!-- end footer column -->
                </div>
            </div>
                ...
                <div class="row mb-5 sm-mb-7 xs-mb-30px">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 d-flex flex-column last-paragraph-no-margin md-mb-40px xs-mb-30px">
                        <a href="index-temp.html" class="footer-logo mb-15px d-inline-block">
                            <img src="{{ asset('images/mentors/Cave-File-L.png') }}" data-at2x="images/demo-elearning-footer-logo@2x.png" alt="">
                        </a>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 ps-4 last-paragraph-no-margin md-mb-40px xs-mb-30px"> 
                        <span class="fw-500 fs-18 d-block text-white mb-10px">Popular Mentors</span>
                        <ul>
                            <li><a href="{{ route('list') }}">Joe Sugarman</a></li>
                            <li><a href="{{ route('list') }}">Terry Dean</a></li>
                            <li><a href="{{ route('list') }}">John Carlton</a></li>
                            <li><a href="{{ route('list') }}">Maxwell Sackhem</a></li>
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-6 text-md-center text-lg-start">
                        ...
                        <div class="d-flex align-items-center justify-content-center justify-content-md-center justify-content-sm-start justify-content-lg-start fs-14">
                            <div class="d-inline-block">Your Privacy Is 100% Protected! Unsubscribe At Any Time.</div> 
                        </div>
                    </div>
                    <!-- end footer column -->
                </div> 
...
</script></span><span class="style4"> - <a href="cavemanswipefile.com" target="_blank">Crafted with Love. Caveman Swipe File. All Rights Reserved.</a></span><br>
</p>
                    </div>
                    <!-- start copyright -->
                </div>
