...
<div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('admin.digital.download.update') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select class="form-control" name="availabilty">
                                        <option value="0" {{ $data->availabilty == 0 ? 'selected' : '' }}>Disabled</option>
                                        <option value="1" {{ $data->availabilty == 1 ? 'selected' : '' }}>Enabled</option>
                                    </select>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select class="form-control" name="status">
                                        ...
                                        <option value="1" {{ $data->status == 1 ? 'selected' : '' }}>Registered Member</option>
                                        <option value="2" {{ $data->status == 2 ? 'selected' : '' }}>Registered Member With Membership Active</option>
                                        <option value="3" {{ $data->status == 3 ? 'selected' : '' }}>Registered Member With Membership Inactive</option>
                                    </select>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    @if ($data->image != null)
                                    <div>
                                        <img src="{{ asset('storage/uploads/' .$data->image) }}" style="height: 110px;"/>
                                    </div>
                                    @endif
                                </div>
                            </div>
