@php 
    ...
    $digitalDownloadView       = $currentRouteName == 'admin.digital.download.view';
    ...
    $digitalContentView       = $currentRouteName == 'admin.digital.content.view';
    ...
    <nav class="navbar-mobile">
        <div class="container-fluid">
            <ul class="navbar-mobile__list list-unstyled">
                    ...
                    {{-- <li class="{{ $currentRouteName == 'admin.termsconditions.edit' ? 'active' : '' }}">
                        <a href="{{ route('admin.termsconditions.edit')}}">
                    ...
                    <li class="{{ $currentRouteName == 'admin.notification.list' ? 'active' : '' }}">
                        <a href="{{ route('admin.notification.list')}}">
                            <i class="fas fa-bullhorn"></i>Notification List
                        </a>
                    </li>
                    ...
                    <li class="{{ $currentRouteName == 'admin.content.list' ? 'active' : '' }}">
                        <a href="{{ route('admin.content.list')}}">
                            <i class="fas fa-folder"></i>Website Settings
                        </a>
                    </li>
    
                    <li class="{{ $digitalDownloadList || $digitalDownloadView || $digitalDownloadView || $digitalDownloadCreate ? 'active' : '' }}">
                        <a href="{{ route('admin.digital.download.list')}}">
                            <i class="fas fa-folder"></i>Digital Download
                        </a>
                    </li>
    
                    <li class="{{ $digitalContentList || $digitalContentView || $digitalContentView || $digitalContentCreate ? 'active' : '' }}">
